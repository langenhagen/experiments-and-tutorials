 ...
 * 
 */
public class MouseForm extends IRSForm {

    private static final String[] FIELDS = {"Name", "Identifier"};

    private static final String[] BUTTONS = {"Accept", "Cancel"};

    private static final String[] COMBO_IRS = {"MOUSE", "DISPLAY", "TOUCHPAD",
            "TOUCHSCREEN", "MICROPHONE", "LOUDSPEAKER", "KEYBOARD"};

    public MouseForm(final EnvironmentElement element, final int frameId) {
    ...
    protected void createElement(final VisualizerManager manager) {
        final InteractionResource resource = ContextFactory.eINSTANCE.createMouse();
