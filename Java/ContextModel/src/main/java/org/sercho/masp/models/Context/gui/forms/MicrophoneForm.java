 ...
 * 
 */
public class MicrophoneForm extends IRSForm {

    private static final String[] FIELDS = {"Name", "Identifier"};

    private static final String[] BUTTONS = {"Accept", "Cancel"};

    private static final String[] COMBO_IRS = {"MICROPHONE", "DISPLAY", "TOUCHPAD",
            "TOUCHSCREEN", "MOUSE", "LOUDSPEAKER", "KEYBOARD"};

    public MicrophoneForm(final EnvironmentElement element, final int frameId) {
    ...
    protected void createElement(final VisualizerManager manager) {
        final InteractionResource resource = ContextFactory.eINSTANCE.createMicrophone();
