 ...
 * 
 */
public class DisplayForm extends IRSForm {

    private static final String[] FIELDS = {"Name", "Identifier"};

    private static final String[] BUTTONS = {"Accept", "Cancel"};

    private static final String[] COMBO_IRS = {"DISPLAY", "TOUCHPAD", "TOUCHSCREEN",
            "MOUSE", "MICROPHONE", "LOUDSPEAKER", "KEYBOARD"};

    public DisplayForm(final EnvironmentElement element, final int frameId) {
    ...
    protected void createElement(final VisualizerManager manager) {
        final InteractionResource resource = ContextFactory.eINSTANCE.createDisplay();
