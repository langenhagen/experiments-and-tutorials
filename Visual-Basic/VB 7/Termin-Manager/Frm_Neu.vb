...
#Region " Vom Windows Form Designer generierter Code "
    ...
    <System.Diagnostics.DebuggerStepThrough()> Private Sub InitializeComponent()
        ...
        Me.Controls.AddRange(New System.Windows.Forms.Control() {Me.tab_Neu, Me.btn_Cancel, Me.btn_Ok, Me.btn_Give})
        Me.FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedDialog
        Me.MaximizeBox = False
        Me.MinimizeBox = False
        Me.Name = "Frm_Neu"
        Me.ShowInTaskbar = False
        Me.Text = "Neuen Termin einstellen"
...
#End Region
    ...
    Private Sub utab_Termin_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles utab_Termin.Click

    End Sub

    Private Sub GroupBox2_Enter(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles grp_Betreff.Enter
    ...
    Private Sub check_Repeat_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles check_Repeat.CheckedChanged
        If check_Repeat.Checked = True Then
            num_Days.Enabled = True
        Else : num_Days.Enabled = False
        End If
    End Sub
