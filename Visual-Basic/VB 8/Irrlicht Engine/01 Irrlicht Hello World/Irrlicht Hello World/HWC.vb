...
Module HWC
    ...
    Sub Main()
        ...
        ' Dim bla As New IrrlichtDevice(DriverType.DIRECT3D9, New Dimension2D(1024, 768), 32, True, False, False, False)
        ...
        Dim MSydney As Irrlicht.Scene.IAnimatedMesh = Device.SceneManager.GetMesh("123.3ds")
        ...
        'Knoten is der Bezug zwischen 3d Welt und 3d Modell (TestSceneNode) macht Würfel
        ...
        Knoten.SetMaterialType(MaterialType.TRANSPARENT_ADD_COLOR)
