...
Namespace IClassTest
    ...
    Class Program
        ...
        Shared Sub Main(ByVal args As String())
            Dim RMPA2 As Program = New Program
            RMPA2.Menu()
        End Sub
        ...
        Public Sub Menu()
            Dev = New IrrlichtDevice(DriverType.DIRECT3D9, New Dimension2D(800, 600), 32, False, True, True)
            Dev.EventReceiver = Me
            Dev.WindowCaption = "Razormaid Project Alpha 2"
