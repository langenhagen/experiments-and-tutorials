...
///////////////////////////////////////////////////////////////
// Kopierkonstruktor der Klasse Liste
Liste::Liste( const Liste& list )
{
	first = last = NULL;	
	first	= list.first;
	last	= list.last;
	ListEl *pEl = list.first;

	for( ; pEl != NULL; pEl = pEl->next )
		pushBack( pEl->datum, pEl->betrag );
}
...
///////////////////////////////////////////////////////////////
// Zuweisungsoperator für Klasse Liste
