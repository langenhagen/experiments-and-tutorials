...
/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/51404*@* */
...
class c_Particle {
  ...
  public void FindClosestCentroid(ArrayList _centroids) {
...
class c_Centroid {
  ...
  public void Tick(ArrayList _particles) {
    ...
    PVector newPosition = new PVector(0.0f, 0.0f);
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "k_means" };
    if (passedArgs != null) {
