/* OpenProcessing Tweak of *@*http://www.openprocessing.org/sketch/147750*@* */
...
void drawLines ()
{
  ...
  while (x < width + abs (versatz))
  {
    ...
    stroke (random (strokeAlpha*0.1, strokeAlpha));

    line (x + random (-0.1, 0.1), noiseValue+3, x + random (versatz*0.9, versatz), noiseValue+3+height);
